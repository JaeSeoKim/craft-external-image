...
const LogContainer: {
  ...
  log: ({ children }) => <div className="flex flex-col gap-2 text-craftSmall p-2">{children}</div>,
  warn: ({ children }) => (
    <div className="bg-yellow-100 text-yellow-700 flex flex-col gap-2 text-craftSmall p-2">{children}</div>
  ),
  error: ({ children }) => (
    <div className="bg-red-100 text-red-700 flex flex-col gap-2 text-craftSmall p-2">{children}</div>
  ),
}
